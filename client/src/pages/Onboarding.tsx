  ...
  const handleNext = async () => {
    ...
    if (step < totalSteps) {
      ...
      try {
        ...
        const { data } = await strapiApi.user.update(user.id, {
          age: formData.age,
      ...
      <div className="onboarding-container">
        ...
        <div className="p-6 pb-10 onboarding-wrapper">
          <div className="flex gap-3 lg:justify-end">
            ...
            <Button onClick={handleNext} disabled={isUpdating} className="max-lg:flex-1 lg:px-10">
              <span className="flex items-center justify-center gap-2">
                {step === totalSteps ? (isUpdating ? 'Saving...' : 'Get Started') : 'continue'}
